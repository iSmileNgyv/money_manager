...
public interface IStockService
{
    ...
    Task<List<GetAllStockWithoutPaginationQueryResponse>> GetAllStocksWithoutPaginationAsync(GetAllStockWithoutPaginationQueryRequest request, CancellationToken ct = default);
}