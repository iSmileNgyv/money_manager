...
public interface IProductService
{
    ...
    Task<List<GetAllProductWithoutPaginationQueryResponse>> GetAllProductWithoutPaginationAsync(GetAllProductWithoutPaginationQueryRequest request, CancellationToken cancellationToken);
}